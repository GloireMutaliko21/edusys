...
import { SidebarAccordeon } from '../global/SidebarAccordeon';
import { SidebarSubLInk } from '../global/SidebarSubLInk';
			...
			>
				...
				>
					<ul className='space-y-1.5 mb-20'>
						<SidebarLink label='Acceuil' link='/'>
							<svg
						...
						<SidebarLink label='Recouvrement' link='/recouvrement'>
							<FcMoneyTransfer className='w-3.5 h-3.5' />
						</SidebarLink>
						<SidebarLink label='Etudiants' link='/students'>
							<svg
								className='w-3.5 h-3.5'
								xmlns='http://www.w3.org/2000/svg'
								width={16}
					...
					<ul className='space-y-1.5 mt-auto'>
						...
						>
							...
							<SidebarSubLInk link='/staffs' label='Agents' />
						</SidebarAccordeon>
						<button
							onClick={logout}
